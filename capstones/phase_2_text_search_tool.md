...
A working Python reference lives at `capstones/solutions/phase_2_text_search_tool/`. **Don't peek before you attempt this yourself** — copying it defeats the entire point of a capstone.
