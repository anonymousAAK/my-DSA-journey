...
A working Python reference lives at `capstones/solutions/phase_5_leaderboard_service/`. **Don't peek before you attempt this yourself** — copying it defeats the entire point of a capstone.
