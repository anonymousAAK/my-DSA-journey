...
A working Python reference lives at `capstones/solutions/phase_6_tinyurl/`. **Don't peek before you attempt this yourself** — copying it defeats the entire point of a capstone.
